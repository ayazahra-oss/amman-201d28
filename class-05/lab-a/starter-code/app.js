...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let answer2 = multiply(answer[0], c);
  return[sum3[0], answer2[0],`${a} and ${b} and ${c} sum to ${sum3[0]}.`,`The product of ${a} and ${b} and ${c} is ${answer2[0]}.`];
}
...
// Write your code here
function multiplyArray(multArr) { //eslint-disable-lin
  let multiply2;
  let multiply3;
...
}return[multi1,`The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${multi1}.`];
}
